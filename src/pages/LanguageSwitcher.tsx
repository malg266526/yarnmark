  ...
  return (
    <Root>
      ...
      <Flags isOpen={isLanguageSwitchOpen}>
        <Button
          onClick={() => onChangeLanguageClicked("pl")}
          aria-label="change_language_to_pl"
        >
          <Icon size={flagIconSize} src={polandIcon} />
        </Button>
        <Button
          onClick={() => onChangeLanguageClicked("en")}
          aria-label="change_language_to_en"
        >
          <Icon size={flagIconSize} src={greatBritainIcon} />
        </Button>
        <Button
          onClick={() => onChangeLanguageClicked("de")}
          aria-label="change_language_to_de"
        >
