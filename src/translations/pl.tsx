  ...
  translation: {
    ...
    tickets: {
      buyTicketsAndWorkshops:
        "<0>Kup</0> bilet na targi lub wybierz opcję z warsztatami",
      ...
      whereToBuy:
        "Bilet wstępu na Krakoski Yarnmark wykupisz na oficjalnej stronie sklepu włóczykijki.pl!",
      keepYourEmail:
        "Zachowaj email z numerem biletu, który dostaniesz po zakupie biletu.",
      proofOfPurchase: "Ten dowód zakupu okażesz przy wejsciu na Yarnmark ;)",
      onlineDeadline:
        "Bilety online bedą dostępne w sprzedaży do 25.04, do godz. 18:00.",
      availability:
        "W dniu wydarzenia bilety bedą dostępne w kasie na miejscu.",
    ...
    welcomeBand: {
      invitation:
        "Serdecznie zapraszamy na III edycję targów włóczki w stolicy Małopolski!",
    ...
    navigationBand: {
      ...
      knittingSaturday:
        "Chodźże spędzić z nami dziewiarską sobotę w grodzie Kraka!",
      linksBelow:
    ...
    previousEdition: {
      ...
      fillTheSurvey:
        "Zapraszamy do podzielenia się Waszą opinią na temat Yarnmarku 2024 w <0>ankiecie</0> ",
    ...
    cashmereTicketsBand: {
      ...
      map: {
        ...
        priceIncludesYarnmarkTicket:
          "Cena zawiera bilet wejścia na targi <strong>Krakoski Yarnmark 2025</strong>",
        route: "Trasa:",
      },
      pleaseBeEarly:
        "Bardzo prosimy o przybycie na miejsce startu rejsu 15min. wcześniej.",
      invitation:
        "Zapraszamy Cię na niezapomniany rejs statkiem po urokliwej Wiśle w Krakowie.",
    ...
    infoForVendorsPage: {
      ...
      invitation:
        "Serdecznie Was zapraszamy do wzięcia udziału w II edycji Krakoskiego Yarnmarku!",
      ...
      hallInfo: {
        ...
        openHours:
          "Wejście na halę w celu rozłożenia stoiska będzie możliwe od godz. 5:00. Na miejscu będzie portier.",
        ...
        extensionCords:
          "W skład stoiska NIE wchodzą przedłużacze, prosimy o posiadanie własnych.",
        socialRoom:
      ...
      parking: {
        title: "Parking",
        parkingSpace:
          "Każdemu wystawcy na dzień targów przysługuje darmowe miejsce parkingowe przy hali.",
      },
      marketing: {
        title: "Marketing",
        sendLogos:
      ...
      registration: {
        ...
        start:
          "Możliwość zakupu stoiska startuje w poniedziałek <strong>22.01.2024r.</strong> o godz. 12:00.",
        where:
          "Rezerwacja stoiska odbywa się poprzez zakup miejsca w sklepie online Włóczykijki.",
