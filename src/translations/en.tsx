...
export const en: TranslationsShape = {
  translation: {
    ...
    tickets: {
      buyTicketsAndWorkshops:
        "<0>Buy</0> ticket to the fair or choose the workshops option",
      cruiseTicketHere:
        "You can find a ticket for the Knitting-ship <0>here</0>",
      ...
      keepYourEmail:
        "Save the email with your ticket number, which you will receive after purchasing your ticket.",
      proofOfPurchase:
        "You will show this proof of purchase when entering Yarnmark ;)",
      availableSoon: "Available soon",
      onlineDeadline:
        "Online tickets will be available for sale until April 25, 6:00 p.m.",
      availability:
        "On the day of the event, tickets will be available at the on-site box office.",
    },
    location: {
    ...
    welcomeBand: {
      invitation:
        "We heartily invite you for III edition of yarn fair in capital of Malopolska!",
    ...
    navigationBand: {
      anotherEdition:
        "The next edition of the Wool Fair in Cracow is ahead of us!",
      knittingSaturday:
        "Come spend your knitting Saturday with us in the city of Krakow!",
      linksBelow:
        "Below you will find few links that will help you plan your time in our beautiful city:",
    ...
    previousEdition: {
      ...
      fillTheSurvey:
        "We kindly invite you to share your opinion about Yarnmark 2024 in the <0>survey</0>",
    ...
    spotBand: {
      ...
      byCar:
        "Near the building there is a small parking lot, that on the day of the event will be free of charge for the fair participants. There is also a small number of parking spaces along Focha Avenue.",
    ...
    cashmereTicketsBand: {
      ...
      pleaseBeEarly:
        "We kindly ask you to arrive at the cruise departure point 15 minutes in advance.",
      map: {
        ...
        priceIncludesYarnmarkTicket:
          "The price includes an entry ticket to the <strong>Krakoski Yarnmark 2025<strong>",
        route: "Route:",
      },
      invitation:
        "We heartily invite you for an unforgettable cruise on the charming Vistula River in Cracow.",
    ...
    infoForVendorsPage: {
      ...
      invitation:
        "We heartily invite you to participate in II edition of Krakoski Yarnmark!",
      ...
      hallInfo: {
        ...
        openHours:
          "Hall entrance in order to prepare the stand will be available at 5.00 AM. Porter will be there.",
        ...
        extensionCords:
          "Stands don't include extension cords, please bring your own",
        socialRoom:
      ...
      parking: {
        title: "Parking lot",
        parkingSpace:
          "Each exhibitor is entitled to a free parking space at the hall on the day of the fair",
      },
      marketing: {
        title: "Marketing",
        sendLogos:
      ...
      registration: {
        ...
        start:
          "Spot reservations start on Monday <strong>22.01.2024r.</strong> at 12:00 AM",
        where:
          "Reservation is done by buying the spot in online shop `Włóczykijki`",
        when: "Stand sales will start in December.",
        buyHere: "Here you will reserve the spot",
        feedback:
          "All data related to payment will be part of feedback confirming spot reservation",
        return:
    ...
    workshops: {
      ...
      drutututu: {
        ...
        materials:
          "<ul><li>włóczkę i druty zapewnia sponsor warsztatów Włóczykijki!</li></ul>",
        aboutMe:
