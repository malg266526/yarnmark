...
export const en: TranslationsShape = {
  translation: {
    ...
    patternsBand: {
      title: 'Yarnmark Patterns',
      viewOnRavelry: 'See pattern on Ravelry',
      slides: {
        waterAlt: 'water',
        wineAlt: 'glass of wine',
        ticketAlt: 'ticket',
        mapAlt: 'map'
      },
      patterns: {
    ...
    cashmereTicketsBand: {
      ...
      map: {
        ...
        time: 'Cruise time:',
        price: 'Price',
        priceIncludesYarnmarkTicket: 'The price includes an entry ticket to the <strong>Krakoski Yarnmark 2026<strong>',
        route: 'Route:'
      },
    ...
    workshops: {
      ...
      iwona: {
        ...
        materials_socks:
          ...
          '</ul>',
        materials_heels: '<ul>' + '<li>Włóczkę dostarcza sponsor <strong>Brioszka</strong></li>' + '</ul>',
        description_socks:
