  ...
  return (
    <>
      ...
      {hallConfigurationState.status === "success" && (
        <Container
          id="hall"
          height={containerSize.height * multiplier}
          width={containerSize.width * multiplier}
        >
          {hallConfigurationState.schema.map((standConfiguration) => {
            return (
              <StandElement
                ...
                height={
                  standConfiguration.height *
                  multiplier *
                  SIZE_MULTIPLIER_FOR_NORMALIZATION
                }
                width={
                  standConfiguration.width *
                  multiplier *
                  SIZE_MULTIPLIER_FOR_NORMALIZATION
                }
              >
                {standConfiguration.type !== "other" && (
                  <div>{standConfiguration.index}</div>
                )}
                {standConfiguration.vendor && (
                  <div>{standConfiguration.vendor}</div>
                )}
